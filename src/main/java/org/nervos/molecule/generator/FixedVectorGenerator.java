...
public class FixedVectorGenerator extends VectorGenerator {
  ...
  void fillTypeBuilderConstructor() {
    MethodSpec constructor =
        constructorBuilder().addStatement("this.items = new $T[0]", itemTypeName).build();

    MethodSpec.Builder constructorBufBuilder =
        constructorBufBuilder()
            .addStatement(
                "int itemCount = $T.littleEndianBytes4ToInt(buf, 0)", base.classNameMoleculeUtils)
