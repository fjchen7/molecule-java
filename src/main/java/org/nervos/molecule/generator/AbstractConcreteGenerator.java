...
public abstract class AbstractConcreteGenerator extends AbstractGenerator {
  ...
  public AbstractConcreteGenerator(
  ...
  protected TypeSpec generate() {
    typeBuilder =
        TypeSpec.classBuilder(className.canonicalName())
            .addModifiers(Modifier.PUBLIC, Modifier.FINAL)
            .superclass(baseTypeClassName)
            .addMethod(constructorBuilder().build());
    typeBuilderBuilder =
        TypeSpec.classBuilder(builderClassName.canonicalName())
    ...
    typeBuilder
        ...
        .addMethod(
            MethodSpec.methodBuilder("builder")
                ...
                .returns(builderClassName)
                .addParameter(
                    ParameterSpec.builder(byte[].class, "buf").addAnnotation(Nonnull.class).build())
  ...
  protected MethodSpec.Builder methodBuildBuilder() {
    return MethodSpec.methodBuilder("build").addModifiers(Modifier.PUBLIC).returns(className);
  }
