...
public final class StructD extends Struct {
    ...
    public static final class Builder {
        ...
        private Builder() {
            ...
            f4 = Byte5.builder().build();
        }

        private Builder(@Nonnull byte[] buf) {
            Objects.requireNonNull(buf);
            if (buf.length != SIZE) {
                throw new MoleculeException(SIZE, buf.length, StructD.class);
            }
            byte[] itemBuf;
            f1 = buf[0];
            f2 = buf[1];
            ...
            itemBuf = Arrays.copyOfRange(buf, 4, 9);
            f4 = Byte5.builder(itemBuf).build();
        }
        ...
        public Builder setF4(@Nonnull Byte5 f4) {
            Objects.requireNonNull(f4);
            this.f4 = f4;
            return this;
        }

        public StructD build() {
