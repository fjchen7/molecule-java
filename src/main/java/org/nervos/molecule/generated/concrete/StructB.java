...
public final class StructB extends Struct {
    ...
    public static final class Builder {
        ...
        private Builder() {
            ...
            f4 = Byte3.builder().build();
        }

        private Builder(@Nonnull byte[] buf) {
            Objects.requireNonNull(buf);
            if (buf.length != SIZE) {
                throw new MoleculeException(SIZE, buf.length, StructB.class);
            }
            byte[] itemBuf;
            f1 = buf[0];
            f2 = buf[1];
            ...
            itemBuf = Arrays.copyOfRange(buf, 4, 7);
            f4 = Byte3.builder(itemBuf).build();
        }
        ...
        public Builder setF4(@Nonnull Byte3 f4) {
