...
public final class BlockV1 extends Table {
  ...
  public static final class Builder {
    ...
    private Builder(@Nonnull byte[] buf) {
      ...
      if (buf.length != size) {
        throw new MoleculeException(size, buf.length, BlockV1.class);
      }
    ...
    public BlockV1 build() {
      ...
      offsets[1] = offsets[0] + uncles.getSize();
      offsets[2] = offsets[1] + transactions.getSize();
      offsets[3] = offsets[2] + proposals.getSize();
      offsets[4] = offsets[3] + extension.getSize();
