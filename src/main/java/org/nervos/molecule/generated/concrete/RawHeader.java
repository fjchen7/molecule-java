...
public final class RawHeader extends Struct {
  ...
  public static final class Builder {
    ...
    public RawHeader build() {
      ...
      MoleculeUtils.setBytes(version.getRawData(), buf, offsets[0]);
      MoleculeUtils.setBytes(compactTarget.getRawData(), buf, offsets[1]);
      MoleculeUtils.setBytes(timestamp.getRawData(), buf, offsets[2]);
      MoleculeUtils.setBytes(number.getRawData(), buf, offsets[3]);
      MoleculeUtils.setBytes(epoch.getRawData(), buf, offsets[4]);
      MoleculeUtils.setBytes(parentHash.getRawData(), buf, offsets[5]);
      MoleculeUtils.setBytes(transactionsRoot.getRawData(), buf, offsets[6]);
      MoleculeUtils.setBytes(proposalsHash.getRawData(), buf, offsets[7]);
      MoleculeUtils.setBytes(extraHash.getRawData(), buf, offsets[8]);
      MoleculeUtils.setBytes(dao.getRawData(), buf, offsets[9]);
