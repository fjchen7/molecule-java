...
public final class RawTransaction extends Table {
  ...
  public static final class Builder {
    ...
    private Builder(@Nonnull byte[] buf) {
      ...
      if (buf.length != size) {
        throw new MoleculeException(size, buf.length, RawTransaction.class);
      }
    ...
    public RawTransaction build() {
      ...
      offsets[1] = offsets[0] + cellDeps.getSize();
      offsets[2] = offsets[1] + headerDeps.getSize();
      offsets[3] = offsets[2] + inputs.getSize();
      offsets[4] = offsets[3] + outputs.getSize();
      offsets[5] = offsets[4] + outputsData.getSize();
      ...
      fieldsBuf[0] = version.getRawData();
      fieldsBuf[1] = cellDeps.getRawData();
      fieldsBuf[2] = headerDeps.getRawData();
      fieldsBuf[3] = inputs.getRawData();
      fieldsBuf[4] = outputs.getRawData();
      fieldsBuf[5] = outputsData.getRawData();
