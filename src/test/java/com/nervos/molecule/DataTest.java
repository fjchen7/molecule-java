...
public class DataTest {
    ...
    @Test
    void testDefault() throws IOException, InvocationTargetException, IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
    ...
    private void testDefaultCase(Map<String, String> testData) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, ClassNotFoundException {
    ...
    private void testSimpleCase(Map<String, java.lang.Object> testData) throws InvocationTargetException, IllegalAccessException, NoSuchMethodException, NoSuchFieldException, ClassNotFoundException {
        ...
        if (arrayClazz.isAssignableFrom(clazz)) {
            ...
            Method f2 = Arrays.stream(builderClazz.getMethods()).filter(x -> Objects.equals(x.getName(), "to" + itemNameUpperFirst)).findAny().get();
